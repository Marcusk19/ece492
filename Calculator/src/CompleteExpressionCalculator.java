...
public class CompleteExpressionCalculator implements CalculatorInterface
{
    ...
    public static void main(String[] args)
    {
        ...
        CalculatorInterface sec = new CompleteExpressionCalculator();
        ...
        while(true)
        {
            ...
            try {
                ...
                if(expression.contains("whenxis")){
                    int xIndex = expression.indexOf("whenxis");
                    String xString = expression.substring(xIndex);
                    double x;
                    ...
                    expression = expression.substring(0, xIndex);
